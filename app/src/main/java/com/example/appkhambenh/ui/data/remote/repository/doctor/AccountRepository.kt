...
interface AccountRepository {
    suspend fun getAccount(fullname: String? = null, email: String? = null, roleId: Int? = null): Flow<ApiState<AccountResponse>>

    suspend fun addAccount(addAccountRequest: AddAccountRequest): Flow<ApiState<AddAccountResponse>>
}