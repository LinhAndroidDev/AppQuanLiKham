...
import com.example.appkhambenh.ui.data.remote.repository.doctor.UpdateInfoPatientRepository
...
@HiltViewModel
class FragmentEditInfoPatientViewModel @Inject constructor(private val repository: UpdateInfoPatientRepository) :
    BaseViewModel() {
